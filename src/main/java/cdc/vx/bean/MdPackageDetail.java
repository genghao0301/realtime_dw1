...
@Data
public class MdPackageDetail implements Serializable {
    /**
     * 主键ID
     */
    //@TableId(value = "md_package_detail_id", type = IdType.AUTO)
    private Long md_package_detail_id;
    ...
    private Date user_def7;

    /**
     * 用户自定义字段8
     */
    //@TableField(value = "user_def8")
    private Date user_def8;
