...
public class DimUtil {
    ...
    public static <T> List<T> getDimInfo(String tableName, Class<T> classz, Tuple2<String, String>... columnValues) {
    ...
    public static <T> List<T> getDimInfo(String tableName, Class<T> classz, List<Tuple2<String, String>> columnValues) {
        return getDimInfo(tableName, classz, columnValues.toArray(new Tuple2[columnValues.size()]));
    }

    public static <T> T getOneDimInfo(String tableName, Class<T> classz, Tuple2<String, String>... columnValues) {
        List<T> list  = getDimInfo(tableName, classz, columnValues);
        return list == null ? null : list.get(0);
    }

    public static <T> T getOneDimInfo(String tableName, Class<T> classz, List<Tuple2<String, String>> columnValues) {
        List<T> list = getDimInfo(tableName, classz, columnValues);
        return list == null ? null : list.get(0);
    }

    public static <T> List<T> getDimInfo(String tableName, String value, Class<T> classz) {
        return getDimInfo(tableName, classz, new Tuple2<>("id", value));
    }
