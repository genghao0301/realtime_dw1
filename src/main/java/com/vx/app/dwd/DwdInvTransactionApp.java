...
////                        mdSkuTuples.add(new Tuple2<>("status",input.getTmpStatus()));
//                        return mdSkuTuples;
//                    }
...
//        //添加DMP园区名称添加进来
        ...
        FlinkKafkaProducer<String> myProducer = new FlinkKafkaProducer<String>(
         ...
         //sink到数据库
        filterStreaam.map(JSON::toJSONString).addSink(myProducer);
